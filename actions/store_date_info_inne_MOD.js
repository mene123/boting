module.exports = {
    ...
    short_description: "Przechowuje date.",
    ...
    <div style="padding-top: 8px;">
        Source Date:<br>
        <textarea id="date" rows="3" placeholder="wstaw tu zmienna jakasz tym typem daty: Fri Apr 06 2018 13:32:10 GMT+0200 albo wpisz ${new Date()}" style="width: 99%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
    </div><br>
    ...
    action: function(cache) {
        ...
        switch(info) {
            ...
            case 8:
                result = date.slice(4, 7);
                if (result == 'Jan') {result = '01';}
                if (result == 'Feb') {result = '02';}
                if (result == 'Mar') {result = '03';}
                if (result == 'Apr') {result = '04';}
                if (result == 'May') {result = '05';}
                if (result == 'Jun') {result = '06';}
                if (result == 'Jul') {result = '07';}
                if (result == 'Aug') {result = '08';}
                if (result == 'Sep') {result = '09';}
